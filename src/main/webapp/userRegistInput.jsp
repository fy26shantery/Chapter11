		...
		<div style="width: 40%" class="container padding-y-5">
			...
			<form action="/uii" method="post">
				<table style="width: 400px; margin: 0 auto;" class="table">
					...
					<tr>
						<th><span class="icon-smile pe-2x pe-va"></span>&nbsp;アイコン&nbsp;</th>



						<td><label class="fancy-radio"><span
								class="icon-user"></span> <input type="radio" name="icon"
								id="icon-user" value="icon-user" class="form-control" required>
						</label></td>


						<td><label class="fancy-radio"><span
								class="icon-user-female"></span> <input type="radio" name="icon"
								id="icon-user-female" value="icon-user-female"
								class="form-control" required> </label></td>
					</tr>
					<tr>
